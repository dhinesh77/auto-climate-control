...
server.send(200,"text/plain","Press RF remote");
...
html+="button{padding:14px;font-size:16px;margin:6px}";
html+="input{padding:10px;font-size:16px}";
html+="</style>";
html+="</head><body>";
...
html+="<div class='card'>";
html+="Temperature: "+String(filteredTemp)+" C<br>";
...
html+="<input name='temp' type='number' step='0.5'>";
...
html+="<a href='/rfToggle'><button>Toggle</button></a><br>";

html+="Automation: ";
html+=automationEnabled?"ON ":"OFF ";
html+="<a href='/autoToggle'><button>Toggle</button></a>";
html+="</div>";
...
if(irReceiverEnabled) irrecv.enableIRIn();
